...
// embedded licensewrapper public key. Sourced from signature_test.go's
// "basic valid signature" fixture, exposed as a constant here so the
// sync_test.go suite can reuse it.
