...
// validLicenseYAML is a signed test license that round-trips through the
// embedded licensewrapper public key. Sourced from
// pkg/license/signature_test.go's "basic valid signature" fixture.
//
// We carry our own copy so the apiserver test suite can verify
// loadAndVerifyLicense end-to-end without importing test code from another
// package.
const validLicenseYAML = `apiVersion: kots.io/v1beta1
kind: License
metadata:
  name: testcustomer
spec:
